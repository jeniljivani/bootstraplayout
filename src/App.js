          ...
          <Container >
            ...
            <Navbar.Collapse id="basic-navbar-nav" className='col-sm-9 col-lg-7 col manu'>
              <Nav className="mx-auto a-center">
                <Nav.Link href="#home" className='p-md-3 p-lg-4'><a >HOME</a></Nav.Link>
                <NavDropdown title="ABOUT" id="basic-nav-dropdown" className='p-md-2 p-lg-3'>
                  <NavDropdown.Item href="#action/3.1">About 1</NavDropdown.Item>
                  <NavDropdown.Item href="#action/3.2">About 2</NavDropdown.Item>
                </NavDropdown>
                <Nav.Link href="#link" className='p-md-3 p-lg-4'><a >PRODUCT</a></Nav.Link>
                <Nav.Link href="#link" className='p-md-3 p-lg-4'><a >BLOG</a></Nav.Link>
                <Nav.Link href="#link" className='p-md-3 p-lg-4'><a >CONTACT</a></Nav.Link>
                <Nav.Link href="#link" className='p-md-3 p-lg-4'><a >SINGUP</a></Nav.Link>
              </Nav>
            </Navbar.Collapse>
